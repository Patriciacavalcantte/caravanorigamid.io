...
<html dir="ltr" lang="pt" class="focus-outline-visible" lazy-loaded="true"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
...
<iron-iconset-svg name="cr" size="24" style="display: none;">
  ...
  <body style="background-color: rgb(255, 255, 255);">
    <iframe id="backgroundImage" src="./bootstrap.bundle.min.js_files/saved_resource(1).html"></iframe>
    <ntp-app></ntp-app>
